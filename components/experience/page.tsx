export default function ExperienceSection() {
  return (
    <section className='flex h-332.75 w-98.25 flex-col items-center gap-6 bg-neutral-950 px-4 py-10 lg:h-236.5 lg:w-360 lg:gap-12 lg:px-30 lg:py-20'>
      {/* Header */}
      <div className='h-11xl flex w-88.25 flex-col gap-2 lg:h-28 lg:w-300 lg:flex-row lg:justify-between'>
      ...
      <div className='flex h-265.75 w-full flex-col gap-4 lg:h-144.5 lg:w-300 lg:gap-8'>
        {/* Card 1 */}
        <div className='flex h-83.25 w-full flex-col gap-4 bg-neutral-950 lg:h-37.5 lg:flex-row lg:justify-between lg:gap-0'>
