export default function StandoutSection() {
  return (
    <section className='flex h-304.5 w-98.25 flex-col items-center justify-center gap-2 px-4 py-10 lg:h-230.5 lg:w-360 lg:gap-12 lg:px-30 lg:py-20'>
      <div className='flex h-25.5 w-full flex-col gap-2 lg:h-32.5 lg:w-300'>
      ...
      <div className='flex h-253 w-full flex-col gap-6 lg:h-155 lg:w-300 lg:flex-row'>
        <div className='py-4xl px-xl bg-secondary-100 flex h-123.5 w-full flex-col items-center gap-6 rounded-2xl lg:h-155 lg:w-147 lg:gap-8 lg:p-8'>
        ...
        <div className='py-4xl px-xl bg-background flex h-123.5 w-full flex-col items-center gap-6 rounded-2xl border border-neutral-300 lg:h-155 lg:w-147 lg:gap-8 lg:p-8'>
